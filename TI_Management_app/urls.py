...
urlpatterns = [
    ...
    # path('TI_Management_app/<int:pk>/editLoyaltyCardIDAdd/',
    #      views.member_loyalty_card_id_add,
    #      name='member_loyalty_card_id_add'),
    ...
    path('TI_Management_app/loyaltyCardsDetail/<int:pk>/<str:category>/',
